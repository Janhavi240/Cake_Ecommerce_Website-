...
public class HomeController 
{
	...
	{
	emserv.sendEmail(em,"Cakes-Newsletter😍💖", "Hello Users 💖💖! Congratulations and a warm welcome to our sweet community! "
			+ "We're absolutely delighted that you've chosen to join us at Cakesss🎂."+"\n"
			+ " Your decision to sign up and connect with us through email means a lot🙌."+"\n"
			+ " Get ready to embark on a delectable journey of flavors and indulgence as we share our passion for baking with you."
			+ " Feel free to drop us a message📧, whether you have questions, special requests, or just want to chat about cakes and desserts."
			+ " We're here to make your cake dreams a reality, one delightful slice at a time😍. "+"\n"
			+ "Thank you for allowing us to be a part of your cake-filled moments, "
			+ "and we can't wait to serve up some mouthwatering sweetness your way😍!\r\n"
			+ "\r\n"
			+ "\r\n"
			+ "\r\n"
			+ "\r\n"
